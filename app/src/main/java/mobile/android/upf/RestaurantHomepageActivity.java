...
//        });
        ...
        navigationView.getMenu().findItem(R.id.nav_restaurant_logout).setOnMenuItemClickListener(menuItem -> {
            FirebaseAuth.getInstance().signOut();
            Log.d(TAG_LOG, "logout:success");
            Intent intent = new Intent(RestaurantHomepageActivity.this, LoginActivity.class);
